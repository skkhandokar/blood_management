...
def heart(request):
    ...
    X = data[:, :-1] #last col sara asbe
    Y = data[:, -1:] #last col asbe
    ...
    if request.method == 'POST':
        ...
        #df.isnull().sum() kon kon value output ase
        #df.isnull().values.any() null ase ki na
        #df[status].value_counts() 0 koyta and 1 koyta ase
        #df.status.fillna(33) value include kora
        #
